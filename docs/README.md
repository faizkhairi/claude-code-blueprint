...
Reference documentation for users who want to understand the blueprint deeply, customize beyond the defaults, or learn the reasoning behind each design choice.

For getting started, see the [root README](../README.md) instead.
...
- **[SETTINGS-GUIDE.md](SETTINGS-GUIDE.md)** — Every env var, permission, and hook explained with rationale
- **[WHY.md](WHY.md)** — Battle stories behind each component
