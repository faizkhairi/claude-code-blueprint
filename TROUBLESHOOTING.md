...
2. **Parallel agent spawns.** Skills like `review-full` spawn up to 4 agents simultaneously, each with its own context window and token budget. Modify the skill to spawn fewer agents for lower-risk changes.
