...
| **別のツールからの移行** | [CROSS-TOOL-GUIDE.md](CROSS-TOOL-GUIDE.md) | 概念は転用可能。*Copilot/Cursor in depth* セクションを参照 |
...
| [クロスツールガイド](CROSS-TOOL-GUIDE.md) - Copilot、Cursor、Cline、Roo Code、OpenCode 他10ツール対応 | 単一ツールのみ |
