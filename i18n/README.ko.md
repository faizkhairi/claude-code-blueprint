...
**자신의 프로젝트에 섞어 넣어 Claude Code를 더 신뢰할 수 있게 만드는, 복사-붙여넣기 가능한 파일 라이브러리 (CLAUDE.md, hooks, agents).**
...
| [**Memory System**](../memory/) | 내장 opt-in: Claude가 실행 간에 환경설정과 세션 컨텍스트를 기억 (개인정보 보호를 위해 git 무시) |
