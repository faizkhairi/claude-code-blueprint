...
**自分のプロジェクトに組み込んで Claude Code をより信頼できるものにする、コピペ可能なファイルのライブラリ（CLAUDE.md、hooks、agents）。**
...
| [**Memory System**](../memory/) | ビルトイン opt-in：Claude が実行間で設定とセッションコンテキストを記憶（プライバシーのため git 無視） |
