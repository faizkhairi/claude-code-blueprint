...
| **다른 도구에서 전환 중** | [CROSS-TOOL-GUIDE.md](CROSS-TOOL-GUIDE.md) | 개념은 이전됨; *Copilot/Cursor in depth* 섹션 참조 |
...
| Copilot, Cursor, Cline, Roo Code, OpenCode 등 10개 도구를 위한 [교차 도구 가이드](CROSS-TOOL-GUIDE.md) | 단일 도구만 |
